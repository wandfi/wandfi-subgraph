...
export class ETH_PtyPoolBelowAARS extends ethereum.SmartContract {
  static bind(address: Address): ETH_PtyPoolBelowAARS {
    return new ETH_PtyPoolBelowAARS("ETH_PtyPoolBelowAARS", address);
  }
